...
|---|---|---|---|
| 📊 [Bradby Insights](https://github.com/dk326/Bradby-Sheild-Insights/blob/main/Bradby%20Insights.ipynb%20-%20Colab.pdf) | 2025 | Pandas, Numpy, Matplotlib, Seaborn | This project analyzes historical Bradby Shield rugby data, providing insights into team performances, match outcomes, and scoring patterns over the years. Visualizations highlight trends and comparisons between Trinity College Kandy and Royal College Colombo, helping fans and analysts better understand the dynamics of this historic two-leg school rugby series |
